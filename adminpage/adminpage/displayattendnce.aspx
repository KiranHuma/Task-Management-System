<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="displayattendnce.aspx.cs" Inherits="adminpage.displayattendnce" %>
  ...
  <main class="container hoc clear"> 
    ...
    <div class="content"> 
      ...
      <h1>See User Task In Details</h1>
        <p>
            <asp:TextBox ID="txtSearch" runat="server" BackColor="#333333" 
                BorderStyle="Ridge" ForeColor="White" style="margin-left: 15px" 
                Width="211px"></asp:TextBox>
            <asp:Button ID="btnSearch" runat="server" onclick="btnSearch_Click" 
                style="margin-left: 15px" Text="Search" Width="80px" />
        </p>
        <p>
