<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="taskdisplay.aspx.cs" Inherits="adminpage.taskdisplay" %>
    ...
    <ul class="clear">
      ...
      <li class="active"><a class="drop" href="#">User Details</a>
        ...
        <li><a href="home.aspx">Regester</a></li>
          <li class="active"><a href="taskdisplay.aspx">Display User Task</a></li>
...
<div class="wrapper overlay bgded" style="background-image:url('http://localhost:54919/images/attendance.png')">
  <div id="breadcrumb" class="hoc clear"> 
    ...
    <ul>
      ...
      <li><a href="#">Display User Task</a></li>
      ...
      <h1>See User Task In Details</h1>
        <p>
            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                ...
                style="margin-left: 31px; margin-right: 0px; text-align: center;" 
                Width="1044px">
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="deisgnation" HeaderText="Designation" 
                        ItemStyle-Width="120px">
                    <ItemStyle Width="120px" />
                    </asp:BoundField>
                    <asp:BoundField DataField="datee" HeaderText="Date" ItemStyle-Width="120px">
                    <ItemStyle Width="120px" />
                    </asp:BoundField>
                    ...
                    <asp:BoundField DataField="taskk" HeaderText="Task" ItemStyle-Width="120px">
                    <ItemStyle Width="120px" />
                    </asp:BoundField>
                </Columns>
